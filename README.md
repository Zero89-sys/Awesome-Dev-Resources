...
* **[Visual Studio Code](https://code.visualstudio.com/)** – Lightweight editor for HTML, CSS, JavaScript, etc.
...
* **Lisp** - Learn the fundamentals of Lisp from core syntax to advanced metaprogramming.
